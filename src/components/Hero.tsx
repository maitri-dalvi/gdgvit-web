...
const Hero = () => {
  ...
  return (
    ...
    <div className='relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-16 md:px-8 lg:px-14'>
      ...
      <div className='relative w-full max-w-6xl text-center'>
        ...
        <motion.h1
          ...
          className='mx-auto max-w-5xl text-5xl font-bold sm:text-6xl lg:text-7xl xl:text-8xl'
        ...
        >
          ...
          <br />
          <span className="block sm:inline">VIT</span>{" "}
          <span className="block sm:inline">Mumbai</span>
        </motion.h1>

        {/* --- Decorative SVGs with Responsive Positioning (Sparkles removed) --- */}
