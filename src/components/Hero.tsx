...
const Hero = () => {
  ...
  // Animation variants for the heading (unchanged)
  ...
  return (
      ...
      <div className='hidden md:flex relative min-h-screen items-center justify-center overflow-hidden px-4 py-16 md:px-8 lg:px-14'>
      ...
      <div className='relative w-full max-w-6xl text-center'>
        ...
        <motion.h1
          ...
          className='mx-auto max-w-5xl text-4xl font-bold sm:text-6xl lg:text-7xl xl:text-8xl'
        ...
        >
          ...
          <span className='relative inline-block'>
            ...
            <svg
              ...
              className='absolute top-1/2 left-1/2 h-[150%] w-[140%] -translate-x-1/2 -translate-y-1/2 -z-10'
            >
              <path
        ...
        <div className='absolute top-[-5%] left-[5%] -rotate-12 text-yellow-mango md:left-[5%] lg:top-[-25%] lg:left-[10%]'>
          <Sparkle fill='#FFD37D' className='h-12 w-12 md:h-25 md:w-25' />
        </div>

        <div className='absolute top-[15%] right-[15%] rotate-12 text-orange sm:top-[20%] md:right-[15%] lg:top-[53%] lg:right-[14%]'>
          <Sparkle fill='#F57642' className='h-12 w-12 md:h-25 md:w-25' />
        </div>

        <div className='absolute top-[50%] -left-4 -rotate-12 text-blue-light sm:top-[60%] sm:-left-8 md:top-1/2 md:left-4 lg:left-8'>
          <AngularBracket1 className='h-auto w-20 text-6xl md:w-32 lg:w-40' />
        </div>

        <div className='absolute top-[0%] -right-4 -rotate-8 text-blue-dark sm:-top-8 sm:-right-6 md:top-0 md:right-4 lg:-top-10 lg:right-1'>
          <AngularBracket2 className='h-auto w-20 text-6xl md:w-32 lg:w-40' />
        </div>

        <Typewriter
          text='Converting Ideas Into Reality!'
          // Responsive font size and margin-top for the typewriter text
          className='mt-16 text-center text-xl font-semibold text-gray-800 sm:text-2xl md:mt-20 md:text-3xl lg:text-4xl'
        />
      </div>
    </div>
  );
