    ...
    <div className='relative flex min-h-[95vh] md:min-h-screen items-center justify-center overflow-hidden px-6 py-12 md:px-8 md:py-16 lg:px-14'>
      ...
      <div className='relative w-full max-w-6xl text-center'>
        ...
        <motion.h1
          ...
          className='mx-auto max-w-5xl text-5xl font-bold sm:text-6xl lg:text-7xl xl:text-8xl leading-tight'
          ...
          <span className="block sm:inline">
            <span className='relative inline-block'>
              ...
              <svg
                ...
                className='absolute top-1/2 left-1/2 h-[140%] w-[120%] -translate-x-1/2 -translate-y-1/2 -z-10 animate-orbit'
              >
                <path
